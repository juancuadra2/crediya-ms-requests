package co.com.jcuadrado.kafka.consumer.config;
...
public class KafkaConfig {
    ...
    public ReceiverOptions<String, String> kafkaReceiverOptions(
        ...
        ReceiverOptions<String, String> basicReceiverOptions = ReceiverOptions.create(kafkaProperties.buildConsumerProperties(sslBundles));
